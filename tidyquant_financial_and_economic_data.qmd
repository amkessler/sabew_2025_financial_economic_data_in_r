...
We can spruce up the chart in any way we want - let's say for example we wanted to
show colors tied to positive or negative returns.
...
Keep in mind that for many such localized measures, the FRED site makes it easy to see a nationwide map of all counties, or the relevant geographies. Let's take a look. 

Sticking with Arlington for a moment, let's examine some other measures.
