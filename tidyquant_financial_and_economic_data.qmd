...
### Embed interactive tables right within your mini-webpage

Want your days of sending multiple versions of spreadsheets files back and forth?  
To leave behind the days of stockdata1, stockdata2, stockdata_final, stockdata_final_final...  
You can actually create interactive, downloadable data tables directly within R
to share your findings with colleages. We'll look at an example using the DT package.
